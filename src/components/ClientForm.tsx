        ...
        <div className="space-y-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="phone2" value={formData.phone2} onChange={(e) => setFormData({...formData, phone2: e.target.value})} />
            </div>
          </div>
          ...
          <div className="grid gap-2">
            <Label htmlFor="accountNumber">IBAN / Número de Cuenta</Label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <Input id="paymentMethod" value={formData.paymentMethod} onChange={(e) => setFormData({...formData, paymentMethod: e.target.value})} />
            </div>
            <div className="grid gap-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <Input id="taxType" value={formData.taxType} onChange={(e) => setFormData({...formData, taxType: e.target.value})} />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="shops">Botigues</Label>
              <Input id="shops" value={formData.shops} onChange={(e) => setFormData({...formData, shops: e.target.value})} />
            </div>
          </div>

          <div className="grid gap-2">
            <Label htmlFor="zones">Zonas</Label>
            <Input id="zones" value={formData.zones} onChange={(e) => setFormData({...formData, zones: e.target.value})} />
          </div>
